...
public class AIDetector : MonoBehaviour
{
    ...
    [SerializeField]
    private LayerMask playLayerMask;
    [SerializeField]
    ...
    private bool CheckTargetVisible()
    {
        ...
        {
            return (playLayerMask & (1 << result.collider.gameObject.layer)) != 0;
        }
        return false;
    }
    ...
    {
        if (Target == null) CheckIfPlayerInRange();
        else if (Target != null) DetectIfOutOfRange();
    }
    ...
    {
        Collider2D collision = Physics2D.OverlapCircle(transform.position, viewRadius, playLayerMask);
        if(collision !=null)
        {
